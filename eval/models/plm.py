...
from .perception_models.apps.plm.generate import (
...
class PerceptionLM(lmms):
    ...
    def __init__(
        self,
        pretrained: str = "facebook/Perception-LM-3B",
        ...
        **kwargs,
        ...
        max_num_tiles = config.get("model").get("max_num_tiles", 16)
        ...
        self._video_max_frames = config.get("model").get("video_max_frames", 16)
    ...
    def generate_until(self, requests: List[Instance]) -> List[str]:
        ...
        for chunk in chunks:
            ...
            self.generator.temperature = 0
            # Default for PLM
            self.generator.top_p = None
            self.generator.top_k = 100

            generation, _, _ = self.generator.generate(messages)
