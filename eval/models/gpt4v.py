...
if API_TYPE == "openai":
    ...
    API_URL = os.getenv("GEMINI_API_URL", "https://generativelanguage.googleapis.com/v1beta/openai")
    API_KEY = os.getenv("GOOGLE_API_KEY", "YOUR_API_KEY")


eval_logger.info(f"API_TYPE detected: {API_TYPE}")
...
class GPT4V(lmms):
    ...
    def encode_video(self, video_path, for_get_frames_num):
        ...
        if for_get_frames_num >= total_frame_num:
            for_get_frames_num = (total_frame_num - 1)
